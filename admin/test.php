...
<table class="table" width="50">
  <tr>
    <td>Change</td>
    <td><select name="selectid" id="selectid" >
  ...
  <tr>
    <td>Title</td>
    <td><input type="text" name="txttitle" placeholder="Title"/></td>
  </tr>
  <tr>
    <td>Description</td>
  ...
  <tr>
    <td>URL</td>
    <td><input type="text" name="txturl" placeholder="Url"/></td>
  </tr>
  <tr>
    <td>Choose Ads</td>
  ...
  <tr>
    <td></td>
    <td><input type="submit" name="btnsub" value="Add" /></td>
  </tr>
</table>
</form>
</body>
