    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Online Posting of Need</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse" align="left">
...
?>
                  ...
                  <li>
                    ...
                    <li>
                        <a href="../userupdateprofile.php"><i class="fa fa-photo"></i>Updateprofile</a>
                    </li>
                    <li>
                        <a href="../usercreateneeds.php"><i class="fa fa-newspaper-o"></i>Post Your Needs</a>
                    </li> 
                    <li>
                        <a href="../user need status.php"><i class="fa fa-star"></i>My Needs Status</a>
                    </li> 
                    <li>
